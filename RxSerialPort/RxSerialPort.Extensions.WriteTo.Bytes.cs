namespace System.IO.Ports
{
	public static partial class RxSerialPort_Extensions
	{
			...
			Action? completedAction = null)
		{
			...
			return source.Subscribe(RxSerialPort_Observer.CreateBytesObserver(portFactory, errorAction, completedAction));
		}
			...
			Action? completedAction = null)
		{
			...
			return source.Subscribe(serialPort.AsBytesObserver(errorAction, completedAction));
		}
	}
}
